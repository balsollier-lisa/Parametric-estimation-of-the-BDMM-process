...
the results of the simulations generated in the Simulations.py file."""
...
"""this program allows to transform too small superdiffusive particles into Brownian particles"""
